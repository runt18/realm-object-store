...
TEST_CASE("sync_metadata: file action metadata", "[sync]") {
    ...
    SECTION("can be properly constructed") {
        ...
        auto user_metadata = SyncFileActionMetadata(manager, SyncAction::HandleRealmForClientReset, original_name);
    ...
    SECTION("properly reflects updating state, across multiple instances") {
        ...
        auto user_metadata_1 = SyncFileActionMetadata(manager, SyncAction::HandleRealmForClientReset, original_name, new_name_1);
        ...
        auto user_metadata_2 = SyncFileActionMetadata(manager, SyncAction::DeleteRealm, original_name, new_name_2);
        REQUIRE(user_metadata_1.original_name() == original_name);
...
TEST_CASE("sync_metadata: file action metadata APIs", "[sync]") {
    ...
    SECTION("properly list all pending actions, reflecting their deletion") {
        ...
        auto first = SyncFileActionMetadata(manager, SyncAction::HandleRealmForClientReset, filename1);
        auto second = SyncFileActionMetadata(manager, SyncAction::HandleRealmForClientReset, filename2);
        auto third = SyncFileActionMetadata(manager, SyncAction::HandleRealmForClientReset, filename3);
